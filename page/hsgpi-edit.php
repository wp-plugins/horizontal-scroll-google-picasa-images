...
if (isset($_POST['hsgpi_form_submit']) && $_POST['hsgpi_form_submit'] == 'yes')
{
	...
	if ($hsgpi_error_found == FALSE)
	{
		...
		if($action == "sus")
		{
			$hsgpi_success = __('Details was successfully updated.', HSGPI_TDOMAIN);
		}
		elseif($action == "err")
		{
...
if ($hsgpi_error_found == FALSE && strlen($hsgpi_success) > 0)
{
	...
	<div class="updated fade">
		...
		<a href="<?php echo HSGPI_ADMINURL; ?>"><?php _e('Click here', HSGPI_TDOMAIN); ?></a> 
...
<div class="form-wrap">
	...
	<form name="hsgpi_form" method="post" action="#" onsubmit="return _hsgpi_submit()"  >
      <h3><?php _e('Edit details', HSGPI_TDOMAIN); ?></h3>
